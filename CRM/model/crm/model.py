...
class CRM(nn.Module):
    #Partie orthographic CCM --> Textured Mesh
    def __init__(self, specs):
        super(CRM, self).__init__()

        self.specs = specs
        # configs
        #aspect de nos données d'entrée du CRM (CCM + MV)
        ...
        #decoder for 3D mesh : images --> features
        ...
        #MLP after the triplane to decode into sdf and rgb    
