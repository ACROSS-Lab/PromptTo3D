...
class OneStagePipeline(object):
    def __init__(
        ...
        """
        only for one stage generate process.
        - the "second" stage was condition on multiview pixel image generated by the MVDream model, generate the final image, based on the stage2-test config
        """
